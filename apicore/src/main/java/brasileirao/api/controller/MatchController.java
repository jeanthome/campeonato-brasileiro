...
public class MatchController {
	 ...
	 *
	 * @param matchInputDto
	 *            DTO com as informações da partida.
	 * @param result
	 *            Bind das validações.
	 * @return ResponseEntity com a resposta HTTP adequada.
	 * @throws ParseException
	 *             Excecão que pode ser lançada ao converter a data.
	 * @throws ServiceException
	 *             Exceção caso não sejam encontrados os times.
	 */
	@PostMapping
	 ...
	 *
	 * @param goalInputDto
	 *            Dto com as informações do gol.
	 * @return ResponseEntity com o status da resposta.
	 * @throws ServiceException
	 *             Exceção das classes de serviço.
	 */
